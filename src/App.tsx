  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md flex items-center justify-between ${isMobile ? 'px-3 pt-2 pb-2' : 'px-5 pt-3 pb-3'}`}>
        ...
        <div className={`${isMobile ? 'text-base' : 'text-lg'} font-inter font-bold text-white flex items-center justify-end gap-2`}>
          <span className="flex items-center gap-1">CONTACT
          ...
          </a><span className="bounce-favicon">.</span>
        </div>
      </header>
